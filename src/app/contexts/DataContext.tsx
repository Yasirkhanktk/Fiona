...
const initialLoanRequests: LoanRequest[] = [
        ...
        reviews: [
          {
            ...
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'ID verification complete. Government-issued ID is valid and matches application details.',
            reviewedAt: '2024-02-24T09:15:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'approved',
            comment: 'ID verified successfully.',
            reviewedAt: '2024-02-25T14:30:00Z',
          },
        ],
      },
      {
        ...
        reviews: [
          {
            ...
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Bank statements show consistent deposits. Average monthly balance is healthy for business size.',
            reviewedAt: '2024-02-24T09:20:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'CONCERN: While deposits are consistent, I noticed several NSF (non-sufficient funds) fees in December 2023 and January 2024. This indicates cash flow management issues. Also, the average balance has been declining over the last 3 months from $8,500 to $4,200. This trend is worrying.',
            reviewedAt: '2024-02-25T14:35:00Z',
          },
        ],
      },
      {
        ...
        reviews: [
          {
            ...
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Revenue records demonstrate steady income from small business operations. Monthly revenue averaging $6,500.',
            reviewedAt: '2024-02-24T09:25:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'MAJOR ISSUE: Revenue records are incomplete and informal. Only handwritten sales ledgers provided, no POS system data or invoices. Cannot verify accuracy of reported income. Additionally, expenses are not documented, making it impossible to assess true profitability. Need formal accounting records or at least 3 months of detailed profit & loss statements.',
            reviewedAt: '2024-02-25T14:40:00Z',
          },
        ],
      },
    ],
    reviews: [
      {
        ...
        reviewerName: 'Sarah Supervisor',
        reviewerRole: 'supervisor',
        comment: 'All required documents submitted. Micro-business shows consistent revenue and healthy banking activity. Approved for funder review.',
      ...
      },
      {
        ...
        reviewerName: 'Michael Funder',
        reviewerRole: 'funder',
        comment: '❌ REJECTED - RETURNED TO SUPERVISOR: Cannot approve this micro-loan due to documentation quality and financial concerns. Key issues: 1) NSF fees and declining bank balance indicate cash flow stress, 2) Revenue documentation is informal and unverifiable (handwritten ledgers only), 3) No expense tracking or profit/loss statements to assess true business health, 4) Recent account balance trend is negative. RECOMMENDATIONS for resubmission: Request borrower to provide: a) 3 months of formal P&L statements, b) Explanation for NSF fees and plan to improve cash management, c) Supporting invoices or POS receipts to verify revenue, d) Consider reducing loan amount to $10,000 or less given current cash position.',
  ...
  {
    id: 'lr8',
    creditId: 'CR-2024-008',
    environmentId: 'e1',
    environmentName: 'Global-Premier SME Facility',
    originatorId: 'c2',
    originatorName: 'Premier Lending Inc',
    borrowerName: 'Metro Construction Ltd',
    amount: 180000,
    currency: 'USD',
    ...
    status: 'rejected',
    submittedAt: '2024-02-19T09:00:00Z',
    documents: [
      {
        id: 'doc23',
        documentTypeId: 'dt1',
        documentTypeName: 'Business Registration Certificate',
        fileName: 'metro_construction_registration.pdf',
        fileSize: 225000,
        uploadedAt: '2024-02-19T08:30:00Z',
        fileUrl: '/mock/documents/metro_registration.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Registration certificate is valid. Company registered 5 years ago with good standing.',
            reviewedAt: '2024-02-20T11:15:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'approved',
            comment: 'Company registration looks legitimate.',
            reviewedAt: '2024-02-21T16:30:00Z',
          },
        ],
      },
      {
        ...
        documentTypeId: 'dt2',
        documentTypeName: 'Financial Statements',
        fileName: 'metro_financials_2023.pdf',
        fileSize: 1280000,
        uploadedAt: '2024-02-19T08:40:00Z',
        fileUrl: '/mock/documents/metro_financials.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Financial statements show consistent revenue. Debt-to-equity ratio is within acceptable limits.',
            reviewedAt: '2024-02-20T11:25:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'MAJOR CONCERN: Cash flow statements reveal significant liquidity issues. Operating cash flow was negative for 2 consecutive quarters. Current ratio dropped from 2.1 to 1.3. This indicates potential difficulty in meeting short-term obligations.',
            reviewedAt: '2024-02-21T16:35:00Z',
          },
        ],
      },
      {
        ...
        documentTypeId: 'dt3',
        documentTypeName: 'Credit Report',
        fileName: 'metro_construction_credit.pdf',
        fileSize: 198000,
        uploadedAt: '2024-02-19T08:50:00Z',
        fileUrl: '/mock/documents/metro_credit.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Credit score of 720 is acceptable. One minor late payment 18 months ago but otherwise clean record.',
          ...
          },
          {
            ...
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'Credit report shows deteriorating payment patterns over the last 6 months. Three 30-day late payments with suppliers. Trade credit lines have been reduced by two major vendors. Score has dropped 45 points since last year.',
            reviewedAt: '2024-02-21T16:40:00Z',
          },
        ],
      },
      {
        ...
        documentTypeId: 'dt4',
        documentTypeName: 'Business Plan',
        fileName: 'metro_business_plan_2024.pdf',
        fileSize: 920000,
        uploadedAt: '2024-02-19T09:00:00Z',
        fileUrl: '/mock/documents/metro_business_plan.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Business plan outlines equipment needs and market expansion. Revenue projections seem reasonable.',
            reviewedAt: '2024-02-20T11:40:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'Business plan lacks risk mitigation strategies given current financial position. Revenue projections appear overly optimistic considering current market conditions in construction sector. No contingency plans for cash flow management.',
            reviewedAt: '2024-02-21T16:45:00Z',
          },
        ],
      },
    ],
    reviews: [
      {
        ...
        reviewerName: 'Sarah Supervisor',
        reviewerRole: 'supervisor',
        comment: 'All documentation complete. Financial position shows stable operations. Approved for funder review.',
      ...
      },
      {
        ...
        reviewerName: 'Michael Funder',
        reviewerRole: 'funder',
        comment: 'REJECTED: While documentation is complete, deep dive into financials reveals concerning trends. Negative cash flow, deteriorating credit, and lack of robust risk management make this too risky at current loan amount. Recommend: 1) Borrower improve cash position first, 2) Reduce loan amount by 40%, or 3) Provide additional collateral/guarantees.',
        createdAt: '2024-02-21T16:50:00Z',
        action: 'rejected',
      },
    ],
    createdAt: '2024-02-19T08:00:00Z',
    updatedAt: '2024-02-21T16:50:00Z',
  },
  {
    id: 'lr9',
    creditId: 'CR-2024-009',
    environmentId: 'e1',
    environmentName: 'Global-Premier SME Facility',
    originatorId: 'c2',
    originatorName: 'Premier Lending Inc',
    borrowerName: 'TechStart Innovations Inc',
    amount: 150000,
    currency: 'USD',
    ...
    documents: [
      {
        ...
        documentTypeId: 'dt1',
        documentTypeName: 'Business Registration Certificate',
        fileName: 'techstart_registration.pdf',
        fileSize: 195000,
        uploadedAt: '2024-02-23T08:30:00Z',
        fileUrl: '/mock/documents/techstart_registration.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Company registration is valid. Tech startup incorporated 2 years ago.',
            reviewedAt: '2024-02-24T10:15:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'approved',
            comment: 'Registration verified and legitimate.',
            reviewedAt: '2024-02-25T15:20:00Z',
          },
        ],
      },
      {
        ...
        documentTypeId: 'dt2',
        documentTypeName: 'Financial Statements',
        fileName: 'techstart_financials_2023.pdf',
        fileSize: 980000,
        uploadedAt: '2024-02-23T08:40:00Z',
        fileUrl: '/mock/documents/techstart_financials.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Financial statements show growth trajectory. Revenue increased 150% YoY. Typical startup burn rate.',
            reviewedAt: '2024-02-24T10:25:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'CRITICAL ISSUE: Burn rate is unsustainable. Company is burning $75k/month with only $120k in the bank. At current rate, they will run out of cash in less than 2 months. Revenue growth is impressive but they are still operating at significant losses. No clear path to profitability shown in projections.',
            reviewedAt: '2024-02-25T15:25:00Z',
          },
        ],
      },
      {
        ...
        documentTypeId: 'dt3',
        documentTypeName: 'Credit Report',
        fileName: 'techstart_owner_credit.pdf',
        fileSize: 165000,
        uploadedAt: '2024-02-23T08:50:00Z',
        fileUrl: '/mock/documents/techstart_owner_credit.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Owner has good personal credit score of 750. No major red flags.',
          ...
          },
          {
            ...
            reviewerRole: 'funder',
            status: 'approved',
            comment: 'Personal credit is acceptable. Owner has good credit history.',
            reviewedAt: '2024-02-25T15:30:00Z',
          },
        ],
      },
      {
        ...
        documentTypeId: 'dt4',
        documentTypeName: 'Business Plan',
        fileName: 'techstart_business_plan.pdf',
        fileSize: 1540000,
        uploadedAt: '2024-02-23T09:00:00Z',
        fileUrl: '/mock/documents/techstart_business_plan.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Comprehensive business plan with detailed market analysis. Product development roadmap is clear.',
            reviewedAt: '2024-02-24T10:45:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'While the business plan is well-written, the financial projections are overly optimistic. The plan shows break-even in 6 months, but given current burn rate and market conditions, this is unrealistic. No contingency planning for delays in product launch or slower customer acquisition. Market size assumptions need validation.',
            reviewedAt: '2024-02-25T15:35:00Z',
          },
        ],
      },
      {
        id: 'doc31',
        documentTypeId: 'dt5',
        documentTypeName: 'Tax Returns',
        fileName: 'techstart_tax_2022_2023.pdf',
        fileSize: 420000,
        uploadedAt: '2024-02-23T09:10:00Z',
        fileUrl: '/mock/documents/techstart_tax.pdf',
        reviews: [
          {
            reviewerId: 'u2',
            reviewerName: 'Sarah Supervisor',
            reviewerRole: 'supervisor',
            status: 'approved',
            comment: 'Tax returns filed on time. Shows consistent losses as expected for early-stage startup.',
            reviewedAt: '2024-02-24T10:50:00Z',
          },
          {
            reviewerId: 'u3',
            reviewerName: 'Michael Funder',
            reviewerRole: 'funder',
            status: 'rejected',
            comment: 'Tax returns confirm significant operating losses. Combined with current cash position, this increases risk profile considerably. Need to see additional equity investment or revenue traction before considering this loan amount.',
            reviewedAt: '2024-02-25T15:40:00Z',
          },
        ],
      },
    ],
    reviews: [
      {
        ...
        reviewerName: 'Sarah Supervisor',
        reviewerRole: 'supervisor',
        comment: 'Innovative tech startup with strong team. All documentation complete. Product has good market potential. Approved for funder review.',
      ...
      },
      {
        ...
        reviewerName: 'Michael Funder',
        reviewerRole: 'funder',
        comment: '❌ REJECTED - RETURNED TO SUPERVISOR: While the business concept is promising, the financial risk is too high at this stage. Critical concerns: 1) Cash runway less than 2 months, 2) Monthly burn rate of $75k unsustainable, 3) Overly optimistic financial projections, 4) No contingency plans. RECOMMENDATION: Request can be reconsidered if borrower: a) Secures additional equity funding first ($200k+), b) Demonstrates revenue traction with 3+ months of consistent sales, c) Reduces loan amount to $75k for working capital only, OR d) Provides personal guarantee plus collateral. Supervisor - please work with originator to address these concerns before resubmission.',
